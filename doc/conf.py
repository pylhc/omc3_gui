# -*- coding: utf-8 -*-
#
# omc3_gui documentation build configuration file, created by
...
version = ABOUT_OMC3_GUI["__version__"][:3]
# The full version, including alpha/beta/rc tags.
release = ABOUT_OMC3_GUI["__version__"]
...
latex_documents = [
    (master_doc, 'omc3_gui.tex', u'omc3_gui Documentation',
     u'OMC-TEAM', 'manual'),
]
...
man_pages = [
    (master_doc, 'omc3_gui', u'omc3_gui Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'omc3_gui', u'omc3_gui Documentation',
     author, 'omc3_gui', 'One line description of project.',
     'Miscellaneous'),
]
...
autodoc_mock_imports = ["accwidgets", "qtpy", "pyqtgraph", "PySide2"]
