import os
from omc3_gui.segment_by_segment_matcher.models.default import (
    MatcherModelDefault,
    MatcherPlotterDefault,
)
from omc3.segment_by_segment.matcher.generic import MatcherFactory
from omc3.segment_by_segment.matcher.coupling import CouplingMatcher
import tfs
...
class MatcherPlotterCoupling(MatcherPlotterDefault):
    ...
    def plot(self):
        ...
        file_coup = tfs.read_tfs(os.path.join(
            outpath, "sbs",
