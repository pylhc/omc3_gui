...
class FieldUIDef:
    ...
    type: Optional[str] = None       # type of the field's data, neds to be instanciable
...
class FieldUI:
    ...
    as generated by :func:`omc3_gui.utils.dataclass_ui.dataclass_ui_builder`
...
class DataClassUI:
    ...
    It's contains a grid-layout that can be added to any QWidget/QLayout.   
    """
